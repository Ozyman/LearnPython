...
# First get two numbers from the user.  Since input() returns a string, we wrap it in a call to int() to immediately convert to an integer
...
# After you've run it, add a line to both sections that performs and prints subtraction.



# Next we are going to show how you can use a file for input instead of having the user enter input on the keyboard.
